...
export const batch2: BlogPost[] = [
  {
    slug: "stellenanzeigen-die-funktionieren",
    title: "Stellenanzeigen die funktionieren: 7 Tipps für mehr Bewerbungen",
    date: "2024-05-18",
...
<blockquote>
<p><strong>Schlecht:</strong> „Attraktive Vergütung"</p>
...
<p><strong>Schlecht:</strong></p>
<ul>
<li>Mindestens 5 Jahre Erfahrung im Bereich Online Marketing</li>
<li>Expertenkenntnisse in Google Ads, Meta Ads, SEO, SEA, Content Marketing, E-Mail-Marketing und Marketing Automation</li>
<li>Fließend Deutsch und Englisch, weitere Sprachen von Vorteil</li>
<li>Abgeschlossenes Studium in BWL, Marketing oder vergleichbar</li>
<li>Erfahrung mit Salesforce, HubSpot und Tableau</li>
</ul>
<p><strong>Gut:</strong></p>
<p><strong>Das bringst du mit (Must-have):</strong></p>
<ul>
<li>2+ Jahre Erfahrung im Performance Marketing (Google Ads oder Meta Ads)</li>
<li>Sicherer Umgang mit Kampagnen-Tracking und KPI-Analyse</li>
<li>Deutsch auf Muttersprachniveau</li>
</ul>
<p><strong>Das wäre ein Plus (Nice-to-have):</strong></p>
<ul>
<li>Erfahrung mit Marketing-Automation-Tools</li>
<li>Grundkenntnisse in SEO</li>
...
<p>Über 60 % der Jobsuchen finden heute auf dem Smartphone statt. Trotzdem sind viele Stellenanzeigen für Desktop-Bildschirme optimiert: endlose Fließtexte, unformatierte Aufzählungen, Bilder die auf kleinen Screens nicht laden.</p>

<blockquote>
<p><strong>Schlecht:</strong> Ein durchgehender Textblock mit 800 Wörtern ohne Absätze, Zwischenüberschriften oder visuelle Gliederung.</p>
<p><strong>Gut:</strong> Kurze Absätze (3–4 Zeilen), klare Zwischenüberschriften, Bullet Points für Aufzählungen, wichtige Infos (Gehalt, Standort, Remote-Anteil) gleich am Anfang.</p>
</blockquote>

<p>Testen Sie Ihre Stellenanzeige auf dem eigenen Smartphone, bevor Sie sie veröffentlichen. Fragen Sie sich: Ist die wichtigste Information (Jobtitel, Standort, Gehalt) ohne Scrollen sichtbar? Ist der Bewerbungs-Button sofort erreichbar? Laden alle Elemente schnell?</p>

<p><strong>Praxis-Tipp:</strong> Wenn ein Bewerber auf dem Smartphone mehr als 30 Sekunden braucht, um den „Jetzt bewerben"-Button zu finden, verlieren Sie Kandidaten. Platzieren Sie den Call-to-Action prominent und wiederholen Sie ihn am Ende der Anzeige.</p>

<h2>6. Bewerbungsprozess vereinfachen</h2>

<p>Jeder zusätzliche Schritt im Bewerbungsprozess kostet Sie Bewerber. Jeder. Pflichtfelder wie „Bitte laden Sie ein Motivationsschreiben hoch" oder „Erstellen Sie zunächst ein Konto" sind Conversion-Killer.</p>

<blockquote>
<p><strong>Schlecht:</strong> 1. Account erstellen → 2. E-Mail bestätigen → 3. Profil ausfüllen (42 Felder) → 4. Lebenslauf hochladen → 5. Anschreiben hochladen → 6. Referenzen angeben → 7. Absenden</p>
<p><strong>Gut:</strong> 1. Lebenslauf hochladen oder LinkedIn-Profil verknüpfen → 2. Drei kurze Fragen beantworten (optional) → 3. Absenden</p>
</blockquote>
...
`,
  ...
  {
    slug: "dsgvo-im-recruiting",
    title: "DSGVO im Recruiting: Was HR-Teams wirklich beachten müssen",
    date: "2024-06-25",
    author: "ShortSelect Team",
    authorRole: "Redaktion",
...
<p>Wichtig: Die Einwilligung muss freiwillig, informiert, spezifisch und unmissverständlich sein. Ein vorausgefülltes Häkchen im Bewerbungsformular reicht nicht aus. Der Bewerber muss aktiv zustimmen und jederzeit widerrufen können, ohne Nachteile für sein Bewerbungsverfahren befürchten zu müssen.</p>

<h2>Einwilligungsmanagement: So machen Sie es richtig</h2>

<p>Die Einwilligung ist im Recruiting-Kontext ein zweischneidiges Schwert. Einerseits ist sie oft die einzige Rechtsgrundlage für bestimmte Verarbeitungen (Talent Pool, Weiterleitung an Dritte). Andererseits stehen Aufsichtsbehörden Einwilligungen im Beschäftigungskontext kritisch gegenüber, weil das Machtverhältnis zwischen Arbeitgeber und Bewerber eine wirklich „freiwillige" Einwilligung fraglich erscheinen lässt.</p>
...
<blockquote>
<p><strong>Praxis-Beispiel für eine Talent-Pool-Einwilligung:</strong></p>
<p>„Ich möchte, dass die Firma X GmbH mein Bewerbungsprofil (Name, Kontaktdaten, Lebenslauf, Qualifikationen) für maximal 12 Monate in ihrem Talent Pool speichert und mich bei passenden Stellenangeboten kontaktiert. Ich kann diese Einwilligung jederzeit per E-Mail an datenschutz@firma-x.de oder über mein Bewerberprofil widerrufen."</p>
</blockquote>

<h2>Löschfristen: Die 6-Monats-Regel</h2>

<p>Eine der häufigsten Fragen im Recruiting-Datenschutz: Wie lange darf man Bewerberdaten aufbewahren? Die Antwort ist überraschend klar.</p>
...
<ul>
<li><strong>Aktives Bewerbungsverfahren:</strong> Daten dürfen verarbeitet werden, solange das Verfahren läuft.</li>
<li><strong>Nach Absage (ohne Einwilligung):</strong> Löschung nach maximal 6 Monaten.</li>
<li><strong>Nach Absage (mit Talent-Pool-Einwilligung):</strong> Speicherung gemäß Einwilligung (üblich: 12 Monate), danach Löschung oder erneute Einwilligung einholen.</li>
...
<ol>
<li><strong>Ob</strong> personenbezogene Daten verarbeitet werden</li>
<li><strong>Welche</strong> Daten konkret gespeichert sind (Kategorien und konkrete Daten)</li>
<li><strong>Zu welchem Zweck</strong> die Verarbeitung erfolgt</li>
<li><strong>An wen</strong> die Daten weitergegeben wurden (z. B. andere Abteilungen, externe Dienstleister)</li>
<li><strong>Wie lange</strong> die Daten gespeichert werden</li>
<li><strong>Welche Rechte</strong> der Betroffene hat (Berichtigung, Löschung, Widerspruch)</li>
</ol>
...
<p><strong>Praxis-Tipp:</strong> Fragen Sie bei der Auswahl eines ATS gezielt nach dem AVV, dem Serverstandort und den TOMs. Seriöse Anbieter stellen diese Informationen proaktiv bereit. ShortSelect etwa speichert alle Daten ausschließlich auf EU-Servern (Frankfurt am Main) und stellt einen AVV standardmäßig zur Verfügung.</p>
...
<ol>
<li><strong>Name und Kontaktdaten des Verantwortlichen</strong> (Ihr Unternehmen)</li>
<li><strong>Kontaktdaten des Datenschutzbeauftragten</strong> (falls vorhanden)</li>
<li><strong>Zweck und Rechtsgrundlage</strong> der Verarbeitung (Bewerbungsverfahren, Art. 6 Abs. 1 lit. b DSGVO / § 26 BDSG)</li>
<li><strong>Empfänger der Daten</strong> (interne Fachabteilungen, ggf. ATS-Anbieter)</li>
<li><strong>Speicherdauer</strong> (z. B. 6 Monate nach Abschluss des Verfahrens)</li>
<li><strong>Rechte der Betroffenen</strong> (Auskunft, Berichtigung, Löschung, Widerspruch, Beschwerde bei Aufsichtsbehörde)</li>
...
<h3>Fehler 1: Bewerbungen per E-Mail ohne Struktur</h3>

<p>Wenn Bewerbungen als E-Mail-Anhänge in verschiedenen Postfächern liegen, haben Sie keine Kontrolle über Zugriff, Weiterleitung und Löschung. Nutzen Sie ein zentrales System mit Zugriffskontrollen und automatischen Löschfristen.</p>
...
<p>Wenn ein Bewerber sich bei Abteilung A bewirbt und seine Unterlagen ohne Einwilligung an Abteilung B oder an ein Schwesterunternehmen weitergeleitet werden, ist das ein Verstoß. Holen Sie vorher eine spezifische Einwilligung ein.</p>

<h3>Fehler 4: Background Checks ohne Anlass</h3>

<p>Das systematische Durchsuchen von Social-Media-Profilen, das Einholen von Schufa-Auskünften oder das Googeln von Bewerbern ist nur zulässig, wenn es einen konkreten, stellenbezogenen Anlass gibt und der Bewerber darüber informiert wurde.</p>

<h2>Checkliste: DSGVO-konformes Recruiting</h2>

<p>Nutzen Sie diese Checkliste als Orientierung für Ihren eigenen Recruiting-Prozess:</p>

<ul>
<li><strong>Rechtsgrundlage definiert:</strong> Für jede Verarbeitung ist eine Rechtsgrundlage dokumentiert (Art. 6 DSGVO / § 26 BDSG).</li>
<li><strong>Datenschutzhinweise erstellt:</strong> In jeder Stellenanzeige ist ein Link zu den Datenschutzhinweisen für Bewerber vorhanden.</li>
<li><strong>Einwilligungen dokumentiert:</strong> Talent-Pool-Einwilligungen werden separat eingeholt, dokumentiert und sind jederzeit widerrufbar.</li>
