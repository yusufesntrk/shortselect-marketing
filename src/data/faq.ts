export const faqs = [
  ...
  },
  {
    ...
    answer: "Nein. Alle zukünftigen Updates und neuen Funktionen sind im Pro Plan enthalten. Es gibt keine Aufpreise für Premium-Module oder neue KI-Features.",
  },
  {
    question: "Wie sicher sind meine Daten?",
    answer: "Ihre Daten werden ausschließlich in EU-Rechenzentren gespeichert und sind durch Row-Level-Security, SSL-Verschlüsselung und tägliche Backups geschützt. ShortSelect ist vollständig DSGVO-konform und bietet Audit-Logging, RBAC und einen AVV-Vertrag.",
  },
  {
    question: "Kann ich meine bestehenden Daten importieren?",
    answer: "Ja. ShortSelect unterstützt CSV-Import für Kandidaten, Jobs und Unternehmen. Unser Onboarding-Team hilft Ihnen beim reibungslosen Umzug von Ihrem bisherigen System, das ist im Pro Plan kostenfrei enthalten.",
  },
];
