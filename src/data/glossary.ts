...
export const glossaryData: Record<string, GlossaryEntry> = {
  ats: {
    ...
    bestPractices: [
      "Waehlen Sie ein ATS mit KI-gestütztem Matching, das Kandidaten automatisch den passenden Stellen zuordnet",
      "Achten Sie auf eine intuitive Kanban-Oberflaeche, die Ihren Recruiting-Prozess visuell abbildet",
      "Pruefen Sie Multi-Tenancy für Agentur-Nutzung -- so verwalten Sie mehrere Kunden in einem System",
  ...
  "time-to-hire": {
    ...
    importance: "Jeder Tag, den eine Stelle unbesetzt bleibt, kostet das Unternehmen Produktivitaet und Umsatz. Studien zeigen, dass die besten Kandidaten innerhalb von 10 Tagen vom Markt verschwinden. Eine lange Time-to-Hire führt nicht nur zu verlorenen Talenten, sondern auch zu frustrierten Hiring Managern und steigenden Kosten.",
    bestPractices: [
    ...
    howShortSelectHelps: "Mit ShortSelect reduzieren Teams ihre Time-to-Hire um durchschnittlich 50% durch KI-gestütztes Screening, automatisiertes Interview-Scheduling und eine visuelle Kanban-Pipeline, die Engpaesse sofort sichtbar macht.",
  ...
  "active-sourcing": {
    ...
    definition: "Statt auf eingehende Bewerbungen zu warten, gehen Recruiter beim Active Sourcing aktiv auf passende Kandidaten zu -- ueber LinkedIn, XING, Fachportale, Konferenzen oder persönliche Netzwerke. Diese Methode ist besonders effektiv für schwer zu besetzende Positionen.",
  ...
  multiposting: {
    ...
    bestPractices: [
      ...
      "Nutzen Sie branchenspezifische Nischenportale zusaetzlich zu den großen Plattformen",
  ...
  "quality-of-hire": {
    ...
    howShortSelectHelps: "ShortSelect unterstuetzt Quality of Hire durch strukturierte Screening-Fragen, KI-gestütztes Matching und das integrierte Feedback-System.",
