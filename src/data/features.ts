...
export const platformFeatures = [
  ...
  },
  {
    ...
    description: "Termine koordinieren ohne E-Mail-Ping-Pong. Kandidaten buchen selbst - Ihr Kalender bleibt synchron.",
    icon: "calendar",
  },
  {
    title: "Talent Pools",
  ...
  {
    title: "Client Portal",
    description: "Geben Sie Ihren Kunden Echtzeit-Einblick in den Recruiting-Fortschritt. Transparent, professionell, beeindruckend.",
    icon: "building-2",
  },
  {
